...
const EMAIL_COPY: Record<EmailLang, EmailCopy> = {
  ...
  it: {
    ...
    subtitleSubscribe:
      "Clicca il pulsante qui sotto e verrai reindirizzato al checkout sicuro di Stripe.",
    buttonTrial: "Inizia prova gratuita",
    buttonSubscribe: "Vai al Checkout",
    footer:
      "Questo link scade tra 15 minuti. Se non l’hai richiesto, puoi ignorare questa email.",
    dir: "ltr",
  },

  fr: {
    subjectTrial: (days) =>
      `Votre lien magique pour démarrer votre essai gratuit de ${days} jours`,
  ...
  es: {
    ...
    subtitleSubscribe:
      "Haz clic en el botón de abajo y serás redirigido al Checkout seguro de Stripe.",
  ...
  de: {
    subjectTrial: (days) =>
      `Dein Magic-Link zum Start deiner ${days}-tägigen Gratis-Testphase`,
    ...
    subtitleSubscribe:
      "Klicke auf den Button unten und du wirst zum sicheren Stripe Checkout weitergeleitet.",
  ...
  pt: {
    ...
    subtitleTrial: (days) =>
      `Clique no botão abaixo para iniciar seu teste de ${days} dias. Não é necessário cartão.`,
    subtitleSubscribe:
      "Clique no botão abaixo e você será redirecionado para o Checkout seguro da Stripe.",
    buttonTrial: "Iniciar teste",
    buttonSubscribe: "Ir para Checkout",
    footer:
      "Este link expira em 15 minutos. Se você não solicitou, pode ignorar este e-mail.",
    dir: "ltr",
  },

  nl: {
    subjectTrial: (days) =>
      `Je magische link om je gratis proefperiode van ${days} dagen te starten`,
    ...
    subtitleSubscribe:
      "Klik op de knop hieronder en je wordt doorgestuurd naar de veilige Stripe Checkout.",
  ...
  sv: {
    subjectTrial: (days) =>
      `Din magiska länk för att starta din ${days}-dagars gratis provperiod`,
    ...
    subtitleSubscribe:
      "Klicka på knappen nedan så skickas du vidare till säker Stripe Checkout.",
    buttonTrial: "Starta provperiod",
    buttonSubscribe: "Gå till Checkout",
    footer:
      "Den här länken går ut om 15 minuter. Om du inte begärde detta kan du ignorera mejlet.",
    dir: "ltr",
  },

  no: {
    subjectTrial: (days) =>
      `Din magiske lenke for å starte din ${days}-dagers gratis prøveperiode`,
    ...
    subtitleSubscribe:
      "Klikk på knappen nedenfor, så blir du sendt til sikker Stripe Checkout.",
    buttonTrial: "Start prøveperiode",
    buttonSubscribe: "Gå til Checkout",
    footer:
      "Denne lenken utløper om 15 minutter. Hvis du ikke ba om dette, kan du ignorere denne e-posten.",
    dir: "ltr",
  },

  da: {
    subjectTrial: (days) =>
      `Dit magiske link til at starte din gratis prøveperiode på ${days} dage`,
    ...
    subtitleSubscribe:
      "Klik på knappen nedenfor, så bliver du sendt videre til sikker Stripe Checkout.",
    buttonTrial: "Start prøveperiode",
    buttonSubscribe: "Gå til Checkout",
    footer:
      "Dette link udløber om 15 minutter. Hvis du ikke anmodede om det, kan du ignorere denne e-mail.",
    dir: "ltr",
  },
    ...
    subtitleSubscribe:
      "Napsauta alla olevaa painiketta ja sinut ohjataan turvalliseen Stripe Checkoutiin.",
  ...
  pl: {
    subjectTrial: (days) =>
      `Twój magiczny link, aby rozpocząć ${days}-dniowy darmowy okres próbny`,
    ...
    subtitleSubscribe:
      "Kliknij przycisk poniżej, a zostaniesz przekierowany do bezpiecznego Stripe Checkout.",
  ...
  tr: {
    ...
    subtitleTrial: (days) =>
      `${days} günlük denemenizi başlatmak için aşağıdaki düğmeye tıklayın. Kart gerekmez.`,
    subtitleSubscribe:
      "Aşağıdaki düğmeye tıklayın ve güvenli Stripe Checkout’a yönlendirileceksiniz.",
    buttonTrial: "Ücretsiz denemeyi başlat",
    buttonSubscribe: "Checkout’a git",
    footer:
      "Bu bağlantı 15 dakika içinde sona erer. Siz talep etmediyseniz bu e-postayı yok sayabilirsiniz.",
    dir: "ltr",
  },

  el: {
    subjectTrial: (days) =>
      `Ο μαγικός σύνδεσμός σας για να ξεκινήσετε τη δωρεάν δοκιμή ${days} ημερών`,
    ...
    subtitleSubscribe:
      "Πατήστε το κουμπί παρακάτω και θα μεταφερθείτε στο ασφαλές Stripe Checkout.",
    buttonTrial: "Έναρξη δοκιμής",
    buttonSubscribe: "Μετάβαση στο Checkout",
    footer:
      "Ο σύνδεσμος λήγει σε 15 λεπτά. Αν δεν το ζητήσατε, μπορείτε να αγνοήσετε αυτό το email.",
    dir: "ltr",
  },

  cs: {
    subjectTrial: (days) =>
      `Váš magický odkaz pro spuštění ${days}denní zkušební verze zdarma`,
    ...
    subtitleSubscribe:
      "Klikněte na tlačítko níže a budete přesměrováni na bezpečný Stripe Checkout.",
    buttonTrial: "Spustit zkoušku",
    buttonSubscribe: "Přejít na Checkout",
    footer:
      "Tento odkaz vyprší za 15 minut. Pokud jste o to nežádali, můžete tento e-mail ignorovat.",
    dir: "ltr",
  },
  ...
  hu: {
    ...
    subtitleSubscribe:
      "Kattints az alábbi gombra, és átirányítunk a biztonságos Stripe Checkout oldalra.",
  ...
  ro: {
    subjectTrial: (days) =>
      `Linkul tău magic pentru a începe perioada de probă gratuită de ${days} zile`,
    ...
    subtitleSubscribe:
      "Apasă butonul de mai jos și vei fi redirecționat către Stripe Checkout securizat.",
    buttonTrial: "Pornește proba",
    buttonSubscribe: "Mergi la Checkout",
    footer:
      "Acest link expiră în 15 minute. Dacă nu ai solicitat acest lucru, poți ignora acest email.",
    dir: "ltr",
  },
  ...
  uk: {
    ...
    subtitleTrial: (days) =>
      `Натисніть кнопку нижче, щоб розпочати ${days}-денну пробу. Картка не потрібна.`,
    subtitleSubscribe:
      "Натисніть кнопку нижче, і вас буде перенаправлено до безпечного Stripe Checkout.",
    buttonTrial: "Почати пробу",
    buttonSubscribe: "Перейти до Checkout",
    footer:
      "Цей лінк дійсний 15 хвилин. Якщо ви цього не запитували, можете проігнорувати цей лист.",
    dir: "ltr",
  },

  ru: {
    subjectTrial: (days) =>
      `Ваша магическая ссылка для запуска бесплатного пробного периода на ${days} дней`,
    ...
    subtitleTrial: (days) =>
      `Нажмите кнопку ниже, чтобы начать пробный период на ${days} дней. Карта не требуется.`,
    subtitleSubscribe:
      "Нажмите кнопку ниже — вы будете перенаправлены в безопасный Stripe Checkout.",
    buttonTrial: "Начать пробный период",
    buttonSubscribe: "Перейти к Checkout",
    footer:
      "Ссылка действует 15 минут. Если вы не запрашивали это, просто проигнорируйте это письмо.",
    dir: "ltr",
  },
  ...
  ar: {
    ...
    subtitleTrial: (days) =>
      `انقر الزر أدناه لبدء تجربة لمدة ${days} يومًا. لا حاجة لبطاقة.`,
    subtitleSubscribe:
      "انقر الزر أدناه وسيتم توجيهك إلى صفحة الدفع الآمنة في Stripe.",
    buttonTrial: "ابدأ التجربة",
    buttonSubscribe: "الانتقال إلى الدفع",
    footer:
      "ستنتهي صلاحية هذا الرابط خلال 15 دقيقة. إذا لم تطلب ذلك، يمكنك تجاهل هذه الرسالة.",
    dir: "rtl",
  },
  ...
  he: {
    ...
    subtitleTrial: (days) =>
      `לחץ על הכפתור למטה כדי להתחיל ניסיון של ${days} ימים. אין צורך בכרטיס.`,
    subtitleSubscribe:
      "לחץ על הכפתור למטה ותועבר לתשלום מאובטח ב-Stripe Checkout.",
    buttonTrial: "התחל ניסיון",
    buttonSubscribe: "עבור ל-Checkout",
    footer:
      "הקישור יפוג בעוד 15 דקות. אם לא ביקשת זאת, אפשר להתעלם מהמייל.",
    dir: "rtl",
  },
  ...
  hi: {
    ...
    subtitleTrial: (days) =>
      `नीचे दिए गए बटन पर क्लिक करके ${days} दिन की ट्रायल शुरू करें। कार्ड की जरूरत नहीं है।`,
    subtitleSubscribe:
      "नीचे दिए गए बटन पर क्लिक करें और आपको सुरक्षित Stripe Checkout पर भेज दिया जाएगा।",
  ...
  bn: {
    ...
    subtitleTrial: (days) =>
      `নিচের বাটনে ক্লিক করে ${days} দিনের ট্রায়াল শুরু করুন। কার্ড প্রয়োজন নেই।`,
    subtitleSubscribe:
      "নিচের বাটনে ক্লিক করলে আপনাকে নিরাপদ Stripe Checkout-এ পাঠানো হবে।",
  ...
  ur: {
    ...
    subtitleTrial: (days) =>
      `نیچے دیے گئے بٹن پر کلک کرکے ${days} دن کی ٹرائل شروع کریں۔ کارڈ درکار نہیں۔`,
    subtitleSubscribe:
      "نیچے دیے گئے بٹن پر کلک کریں اور آپ کو محفوظ Stripe Checkout پر بھیج دیا جائے گا۔",
  ...
  id: {
    ...
    subtitleTrial: (days) =>
      `Klik tombol di bawah untuk memulai uji coba ${days} hari. Tidak perlu kartu.`,
    subtitleSubscribe:
      "Klik tombol di bawah dan Anda akan diarahkan ke Stripe Checkout yang aman.",
  ...
  ms: {
    ...
    subtitleTrial: (days) =>
      `Klik butang di bawah untuk memulakan percubaan ${days} hari. Tiada kad diperlukan.`,
    subtitleSubscribe:
      "Klik butang di bawah dan anda akan diarahkan ke Stripe Checkout yang selamat.",
  ...
  th: {
    ...
    subtitleTrial: (days) =>
      `คลิกปุ่มด้านล่างเพื่อเริ่มทดลองใช้ ${days} วัน ไม่ต้องใช้บัตร`,
    subtitleSubscribe:
      "คลิกปุ่มด้านล่าง แล้วคุณจะถูกนำไปยัง Stripe Checkout ที่ปลอดภัย",
    buttonTrial: "เริ่มทดลองใช้ฟรี",
    buttonSubscribe: "ไปที่ Checkout",
    footer:
      "ลิงก์นี้จะหมดอายุใน 15 นาที หากคุณไม่ได้ร้องขอ คุณสามารถเพิกเฉยอีเมลนี้ได้",
    dir: "ltr",
  },
  ...
  vi: {
    ...
    subtitleTrial: (days) =>
      `Nhấn nút bên dưới để bắt đầu dùng thử ${days} ngày. Không cần thẻ.`,
    subtitleSubscribe:
      "Nhấn nút bên dưới và bạn sẽ được chuyển đến Stripe Checkout an toàn.",
    buttonTrial: "Bắt đầu dùng thử",
    buttonSubscribe: "Đi tới Checkout",
    footer:
      "Liên kết này hết hạn sau 15 phút. Nếu bạn không yêu cầu, bạn có thể bỏ qua email này.",
    dir: "ltr",
  },
  ...
  ja: {
    ...
    subtitleTrial: (days) =>
      `下のボタンをクリックして${days}日間のトライアルを開始してください。カードは不要です。`,
    subtitleSubscribe:
      "下のボタンをクリックすると、安全なStripe Checkoutに移動します。",
    buttonTrial: "トライアル開始",
  ...
  ko: {
    ...
    subtitleTrial: (days) =>
      `아래 버튼을 눌러 ${days}일 체험을 시작하세요. 카드가 필요 없습니다.`,
    subtitleSubscribe:
      "아래 버튼을 누르면 안전한 Stripe Checkout으로 이동합니다.",
    buttonTrial: "체험 시작",
    buttonSubscribe: "Checkout으로",
    footer:
      "이 링크는 15분 후 만료됩니다. 요청한 적이 없다면 이 이메일을 무시해도 됩니다.",
    dir: "ltr",
  },
  ...
  zh: {
    ...
    subtitleSubscribe:
      "点击下方按钮，你将被重定向到安全的 Stripe Checkout。",
    buttonTrial: "开始试用",
    buttonSubscribe: "前往 Checkout",
    footer:
      "此链接将在 15 分钟后过期。如果不是你本人请求的，可忽略此邮件。",
    dir: "ltr",
  },
};
...
export async function sendMagicLinkEmail({
  ...
  const subject = isTrial ? copy.subjectTrial(days) : copy.subjectSubscribe;
  const title = isTrial ? copy.titleTrial : copy.titleSubscribe;
  const subtitle = isTrial ? copy.subtitleTrial(days) : copy.subtitleSubscribe;
  const buttonText = isTrial ? copy.buttonTrial : copy.buttonSubscribe;
